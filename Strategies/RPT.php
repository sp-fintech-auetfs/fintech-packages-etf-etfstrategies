...
class RPT extends EtfStrategies
{
    public $strategyDisplayName = 'Return Percentage Threshold (RPT)';

    public $strategyDescription = 'Perform return percentage threshold strategy on portfolio open orders. When threshold percentage is reached, orders will be sold.';
