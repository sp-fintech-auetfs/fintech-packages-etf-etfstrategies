...
namespace Apps\Fintech\Packages\Etf\Strategies;
...
use Apps\Fintech\Packages\Etf\Strategies\Model\AppsFintechEtfStrategies;
use System\Base\BasePackage;

class EtfStrategies extends BasePackage
{
    protected $modelToUse = AppsFintechEtfStrategies::class;

    protected $packageName = 'etfstrategies';

    public $etfstrategies;
    ...
    public function getEtfStrategiesByName($name)
    {
    ...
    public function applyStrategy($data)
    {
        ...
        $progressFile = $this->basepackages->progress->checkProgressFile('etfportfoliostrageties');
    ...
    {
        if ($this->basepackages->progress->checkProgressFile('etfportfoliostrageties')) {
            $this->basepackages->progress->deleteProgressFile('etfportfoliostrageties');
        }
    ...
    public function getEtfStrategiesById($id)
    {
        //
    }

    public function addEtfStrategies($data)
    {
        //
    }

    public function updateEtfStrategies($data)
    {
        //
    }

    public function removeEtfStrategies($data)
    {
        //
    }

    protected function getSchemeFromEtfCodeOrSchemeId($data, $includeNavs = false)
    {
        $this->schemePackage = $this->usePackage(EtfSchemes::class);

        return $this->schemePackage->getSchemeFromEtfCodeOrSchemeId($data, $includeNavs);
    }
}